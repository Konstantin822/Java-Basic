...
//        int a = 10;
//
        // Увеличение значения переменной (короткая запись)
//        a += 5;     // a = a + 5
//        System.out.println(a);
        // Уменьшение значения переменной (короткая запись)
//        a -= 5;     // a = a - 5
//        System.out.println(a);
        // Умножение значения переменной (короткая запись)
//        a *= 5;    // a = a * 5
//        System.out.println(a);
        // Деление значения переменной (короткая запись)
//        a /= 5;   // a = a / 5
//        System.out.println(a);
        // Процент от деления значения переменной (короткая запись)
//        a %= 3;     // a = a % 5
//        System.out.println(a);
